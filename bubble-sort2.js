...
/*
for(let prop in candidatos[0]) { // ########  ESSE CODIGO ENCONTRA A PROPRIEDADE DO OBJETO QUE ESTIVER NO VETOR  #########
    console.log(prop)
}
process.exit(0)
*/
...
//Fazendo um map() para produzir um novo vetor só com os nomes dos candidatos se tornarmos o o.NM_CANDIDATO em vetores e colocarmos uma virgula podemos chamr mais algum nome
...
// localeCompare() faz corretamente a ordenação considerando os acentos, mas é MUITO mais lento do que a comparação binaria padrão
